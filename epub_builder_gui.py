...
DEFAULT_OCR_PROMPT_EN = (
    "You are an OCR engine for audiobook-friendly text. Extract only the text visible in the image. "
    "Remove citation markers like [12], (Smith, 1999), or ¹. Expand abbreviations (e.g. -> for example, "
    "Dr. -> Doctor). Ignore headers, footers, and page numbers. Fix line-break hyphenations. "
    "Keep paragraphs intact and return pure running text in the original language."
)
DEFAULT_OCR_PROMPT_DE = (
    "Du bist eine OCR-Engine für hörbuchfreundlichen Text. Extrahiere ausschließlich den Text, "
    "der im Bild sichtbar ist. Entferne Zitationsmarker wie [12], (Smith, 1999) oder ¹. "
    "Schreibe Abkürzungen aus (z. B. -> zum Beispiel, Dr. -> Doktor). "
    "Ignoriere Kopf-/Fußzeilen und Seitenzahlen. Korrigiere Worttrennungen am Zeilenende. "
    "Erhalte Absätze und gib reinen Fließtext in der Originalsprache zurück."
)
DEFAULT_TOC_PROMPT_EN = (
    "Extract the table of contents from the image(s). "
    "Return only top-level chapters. Ignore dotted leader lines (e.g., Chapter 1 ........ 5). "
    "Format each line as: TITLE ::: PAGE. Keep titles exactly as shown, no subchapters. "
...
DEFAULT_TOC_PROMPT_DE = (
    ...
    "Gib ausschließlich die Hauptkapitel aus. Ignoriere Punktlinien (z. B. Kapitel 1 .... 5). "
    "Format pro Zeile: TITEL ::: SEITE. Behalte Titel exakt bei, keine Unterkapitel. "
